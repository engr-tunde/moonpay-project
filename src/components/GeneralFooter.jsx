      ...
      <div className="container text-white">
         ...
         <div className="flex flex-col lg:hidden gap-10 mb-7">
             <p className="text-[11.2px] text-[#5e5d5d]">All rights reserved. MoonPay USA LLC is a registered money service business (NMLS ID: 2071245). For Law Enforcement requests please direct your official document to our compliance team here.
              ...
              <form action="" className="flex flex-col gap-4">
                ...
                <input type="submit" value="Subscribe" className="bg-[#2a2a2a] text-[12px] py-2 px-2 rounded-lg  w-[150px]"/>
                </div>
                <div className="flex gap-2">
                  <input type="checkbox" className="bg-[#2a2a2a] accent-[#2a2a2a] text-[#2a2a2a] w-[18px]"/>
                  <label htmlFor="" className="w-[420px] text-[11px] text-[#434235] leading-4">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 lg:gap-0 mt-7">
            <div className="col-span-1 flex flex-col gap-6">
              ...
              <Link className="hover:text-white">Buy Crypto</Link>
              <Link className="hover:text-white">Sell Crypto</Link>
              <Link className="hover:text-white">Swap Crypto</Link>
              <Link className="hover:text-white">Learn about Crypto</Link>
              <Link className="hover:text-white">Crypto Price</Link>
              </div>
            </div>
