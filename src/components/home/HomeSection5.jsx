    ...
    return(
        <div className="py-8">
            ...
            <div>
                ...
                <div className="bg-black flex flex-col items-center gap-5 ">
                ...
                <div className="bg-black">
                    ...
                    <div className="container mt-8 w-full rounded-3xl">
                ...
                <div className="container flex flex-col gap-4">
                    <h1 className="text-[50px]">See what our customers say</h1>
                    <Link to="" className="flex items-center gap-1 border-[1px] border-[#ddd] w-max py-1.5 px-5 rounded-lg">
                    ...
                    <p className="text-[18px] w-[480px] font-semibold">With over 100,000 reviews, MoonPay is one of the most reviewed and highest scoring platforms for crypto.</p>
                </div>
            </div>
        </div>
    )
